...
class OpenFoodFactsService {
  ...
  static const String _userAgent = 'JuanTracker/1.0 (Flutter; Android; es-ES; contact@juantracker.app)';
  ...
  Future<Response> _executeWithRetry(
    ...
    try {
      _debugLog('Request (attempt $attempt): $path');
      _recordRequest();
      ...
      // Si fue cancelado, propagar como SearchCancelledException
      ...
      if (e.type == DioExceptionType.connectionError ||
        ...
        if (attempt < _maxRetries) {
          ...
          _debugLog('Network error: ${e.message}, retrying in ${delay.inMilliseconds}ms...');
          await Future<void>.delayed(delay);
          return _executeWithRetry(
            path,
            queryParameters: queryParameters,
  ...
  /// - [cancelToken]: Token para cancelar la petición
  ...
  Future<OpenFoodFactsSearchResponse> _executeSearch(
    ...
    final queryParams = <String, dynamic>{
      ...
      // ORDENAMIENTO: unique_scans_n (escaneos) es más relevante
  ...
  Future<OpenFoodFactsResult?> searchByBarcode(String barcode, {CancelToken? cancelToken}) async {
